        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <h1>Consultation Form: <a href="">Health Nerds</a></h1>
                    ...
                    <form id="contact-form" method="post" role="form">
                        ...
                        <div class="controls">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="form_blood_type">Blood Type</label>
                                        <input id="form_blood_type" type="text" name="name" class="form-control" placeholder="Please enter your blood type"  data-error="blood type is required.">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="form_location" type="text" name="name" class="form-control" placeholder="Please enter your Location"  data-error="Location is required.">
                                        <div class="help-block with-errors">
                                           </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="text-muted"><strong>*</strong> These fields are required. <a href="" target="_blank"></a>.</p>
                                </div>
                            </div>
                        </div>
